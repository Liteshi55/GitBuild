...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_u_htrfnwe);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_u_htrfnwe);
...
#define __pyx_n_u_htrfnwe __pyx_mstate_global->__pyx_n_u_htrfnwe
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_n_u_htrfnwe, __pyx_k_htrfnwe, sizeof(__pyx_k_htrfnwe), 0, 1, 0, 1},
...
__Pyx_PyMODINIT_FUNC init__init__(void) { inithtrfnwe(); }
#endif
__Pyx_PyMODINIT_FUNC inithtrfnwe(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_htrfnwe(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_htrfnwe(); }
#endif
...
if (!__Pyx_RefNanny) {
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_n_u_htrfnwe) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
